            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="space-y-8 text-gray-700 leading-relaxed">
                    <section>
                        ...
                        <p>
                            Using <strong className="text-gray-900">AppyScreen</strong> (“the Service”) constitutes your agreement to these Terms of Service.
                        </p>
                        <p className="mt-2">If you do not agree, please do not use the platform.</p>
                    </section>

                    <section>
                        <h2 className="text-2xl font-semibold text-gray-900 mb-4">Service</h2>
                        <p>
                            AppyScreen provides an AI-powered platform that creates short-form videos based on the content, inputs, and media you provide.
                        </p>
                    ...
                    <section>
                        ...
                        <p className="mb-2">
                            By using AppyScreen, you grant us a <strong className="text-gray-900">worldwide, non-exclusive, royalty-free license</strong> to:
                        </p>
                        <ul className="list-disc pl-5 space-y-2">
                            <li>Use</li>
                            <li>Host</li>
                    ...
                    <section>
                        ...
                        <p className="mb-2">You agree <strong className="text-gray-900">not</strong> to upload or generate content that is:</p>
                        <ul className="list-disc pl-5 space-y-2">
                    ...
                    <section>
                        <h2 className="text-2xl font-semibold text-gray-900 mb-4">Fees & Payment</h2>
                        <p className="mb-2">Where applicable:</p>
                        <ul className="list-disc pl-5 space-y-2">
                            <li>Fees are listed at the time of purchase</li>
                            <li>Subscriptions renew automatically unless cancelled</li>
                            <li>You may cancel your subscription at any time</li>
                            <li>Refunds follow AppyScreen’s published refund policy</li>
                        </ul>
                    ...
                    <section>
                        ...
                        <p className="mb-2">
                            AppyScreen is provided <strong className="text-gray-900">“as is”</strong> and <strong className="text-gray-900">“as available.”</strong>
                        </p>
                    ...
                    <section>
                        ...
                        <ul className="list-disc pl-5 space-y-2">
                            <li>AppyScreen is not liable for indirect, incidental, special, or consequential damages</li>
                    ...
                    <section>
                        ...
                        <p>
                            These Terms are governed by the laws of <strong className="text-gray-900">New South Wales, Australia</strong>, excluding conflict-of-law principles.
                        </p>
                    </section>
