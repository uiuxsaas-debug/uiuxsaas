...
function ScreenFrame({
    ...
    return (
        ...
        >
            <div className="flex gap-2 items-center bg-white border border-black/10 rounded-xl p-4 shadow-sm">
                <ScreenHandler
                    screen={screen}
                    theme={theme}
                    iframeRef={iframeRef}
            ...
            <iframe
                ...
                ref={iframeRef}
                className="w-full rounded-2xl mt-3 border border-black/10 shadow-lg shadow-black/10"
